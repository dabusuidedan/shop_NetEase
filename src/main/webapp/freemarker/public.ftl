...
<div class="n-support">请使用Chrome、Safari等webkit内核的浏览器！</div><div class="n-head">
    <div class="g-doc f-cb">
        <div class="user">
               卖家你好，<span class="name">seller</span>！<a href="../user/logout.action">[退出]</a>
        </div>
        <ul class="nav">
    ...
    <div class="n-public">
        <form class="m-form m-form-ht" id="form" method="post" action="../home/publicSubmit.action" onsubmit="return false;" autocomplete="off">
            <div class="fmitem">
